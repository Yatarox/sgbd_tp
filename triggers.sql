...
--creation du trigger TR_UpdateStockRobot
...
--creation du trigger TR_UpdateStockParts
...
END;
GO
--si le travailleur a deja un contrat actif dans la meme usine, on ne peut pas creer un nouveau contrat
--creation du trigger TR_CheckActiveContract
